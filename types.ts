...
export const ALL_PERMISSIONS = [
  ...
  'view_form_candidate_zuheyru',
  'view_form_candidate_mahfooz',
  'view_form_candidate_faiga',
  'view_form_candidate_jabir',
  'view_form_candidate_mihana',
  'view_form_candidate_zahura',
  'view_form_candidate_zulaikha',
  'view_form_candidate_sodhiq',
  'edit_voter_shafaa',
  'edit_voter_mashey',
  'edit_voter_zuheyru',
  'edit_voter_mahfooz',
